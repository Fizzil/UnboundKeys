...
#   Start-Process binRelease
et8.0-windowsUnboundKeys-v4.0.0.exe
...
# (binReleaseUnboundKeys-v<new>). ASCII only: read as ANSI.
...
if (-not $result.StartsWith("UnboundKeys 4")) { Log "not an update; stopping"; exit 0 }
